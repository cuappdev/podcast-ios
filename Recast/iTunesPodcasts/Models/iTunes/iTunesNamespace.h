...
//@property (nullable, nonatomic) NSString *block;
//
...
///// </itunes:category>
//@property (nullable, nonatomic) NSArray<ITunesCategory *> *categories;
//
...
//@property (nullable, nonatomic) NSString *complete;
//
...
//@property (nullable, nonatomic) NSString *theNewFeedUrl;
//
...
//@property (nullable, nonatomic) ITunesOwner *owner;
//
...
//@property (nullable, nonatomic) NSString *subtitle;
//
...
//@property (nullable, nonatomic) NSString *keywords;
//
