...
//@property (nullable, nonatomic) NSString *descriptionText;
//
...
//@property (nullable, nonatomic) Enclosure *enclosure;
//
...
///// particular.
//@property (nullable, nonatomic) NSString *guid;
//
...
//@property (nullable, nonatomic) ItemSource *source;
//
//// MARK: - Namespaces
//
...
//
//@property (nullable, nonatomic) DownloadInfo *downloadInfo;
//
//@end
