...
@property (nonatomic, nullable) NSURL *artworkUrl30;
@property (nonatomic, nullable) NSURL *artworkUrl60;
@property (nonatomic, nullable) NSURL *artworkUrl100;
@property (nonatomic) NSString *collectionExplicitness;
@property (nonatomic) NSString *primaryGenreName;
@property (nonatomic, nullable) NSURL *artworkUrl600;
@property (nonatomic) NSArray<NSString *> *genreIds;
...
//@property (nullable, nonatomic) NSString *docs;
//
...
//@property (nullable, nonatomic) Cloud *cloud;
//
///// The PICS rating for the channel.
//@property (nullable, nonatomic) NSString *rating;
//
...
//@property (nullable, nonatomic) NSURL *image;
//
...
//@property (nullable, nonatomic) NSArray<Episode *> *items;
//
//// MARK: - Namespaces
//
///// iTunes Podcasting Tags are de facto standard for podcast syndication.
///// See https://help.apple.com/itc/podcasts_connect/#/itcb54353390
//@property (nullable, nonatomic) ITunesNamespace *iTunes;
//
...
///// element.
//@property (nullable, nonatomic) NSArray<NSNumber *> *rawSkipDays;
//
...
//@property (nullable, nonatomic) TextInput *textInput;
//
...
//@property (nullable, nonatomic) NSArray<NSNumber *> *skipHours;
